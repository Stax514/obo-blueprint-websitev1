    ...
    <footer className="bg-[#0D0D0D] text-[#FAFAF7] mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                ["Applications", "/high-school/applications"],
                ["Extracurriculars", "/high-school/extracurriculars"],
                ["Financial Aid", "/high-school/financial-aid"],
              ].map(([label, href]) => (
                <li key={href}>
        ...
        <div className="mt-12 pt-8 border-t border-[#1F1F1F] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <p className="text-[#6B7280] text-xs">© 2024 Tsadiku and Adiyah Obolu. All rights reserved.</p>
