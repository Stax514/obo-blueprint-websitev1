...
const tracks = [
  ...
  },
  {
    ...
    desc: "LeetCode strategy, system design, behavioral prep, and how to get your first internship. Coming soon.",
    inside: ["DSA Roadmap", "System Design", "Behavioral", "Internship Guide", "Resume Templates", "Mock Interviews"],
  ...
  },
  {
    id: "consulting",
    label: "Consulting",
    tagline: "Get into MBB and the Big 4.",
    desc: "Case interview frameworks, resume cold templates, networking scripts, and fit prep. Coming soon.",
    inside: ["Case Frameworks", "Fit Interviews", "Networking Scripts", "Resume", "MBB vs Big 4", "Timeline"],
    status: "loading" as const,
    href: null,
    accent: "bg-[#6B6B6B]",
    accentText: "text-[#6B6B6B]",
